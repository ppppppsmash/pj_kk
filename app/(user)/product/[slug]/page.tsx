...
export default function Page({ params } : { params: { slug: string }}) {
  return (
    <div>
      ...
      <section>
        <div className="max-w-[900px] w-full mx-auto mt-5 mb-16">
          <img className="rounded-lg" src="/images/main-visual.jpg" />
        </div>
        ...
        <div className="max-w-[800px] w-full mx-auto mt-5 mb-16">
          ...
          <h2 className="sm:w-[calc(100%_-_50px)] sm:p-6 sm:mt-10 sm:mb-5 bg-gray font-bold leading-[1.4] sm:rounded-[25px] text-[24px]">副標題副標題副標題副標題副標題副標題</h2>
