        ...
        {product_list.map((product, index) => (
          <div
            ...
            className="md:w-[calc(100%_/_3_-_3.5%)] sm:w-[calc(100%_/_2_-_2.5%)] w-auto relative
              h-[370px] rounded-[30px] overflow-hidden shadow-[6px_4px_15px_0_rgba(51,51,51,.19)]
              mb-8 sm:mb-20"
          >
          <Link
            href={product.link}
            className="block h-full pb-6 bg-white overflow-hidden relative z-10"
          >
            <div className="h-full sm:mb-4 overflow-hidden rounded-[50px]">
              <img
                src={product.imgThumb}
                className="w-full mx-auto h-full object-cover duration-300 hover:scale-[1.2]"
              />
            </div>
